  ...
  Array(25).concat([
    ...
    function (t, e, a) {
      var r = {
        ...
        "./portfolio.gif": 166,
        "./programmer.svg": 167,
        "./projects_image.svg": 168,
        "./pwa.png": 169,
        "./saayaHealthLogo.png": 170,
        "./stanford_logo.png": 171,
    ...
    function (t) {
      t.exports = JSON.parse(
        '{"data":[{"id":"project_1","name":"Gold Rate Live","createdAt":"2022-05-01T00:00:00Z","url":"#","description":"Android app showing live gold rates using real-time APIs. Built with MVVM architecture and integrated AdMob for monetization.","isFork":false,"languages":[{"name":"Java","iconifyClass":"logos:java"},{"name":"XML","iconifyClass":"vscode-icons:file-type-xml"}]},{"id":"project_2","name":"Software Update Utility","createdAt":"2022-01-15T00:00:00Z","url":"#","description":"A utility Android app to check updates for installed applications. Integrated ads, background service, and RecyclerView listing.","isFork":false,"languages":[{"name":"Java","iconifyClass":"logos:java"},{"name":"XML","iconifyClass":"vscode-icons:file-type-xml"}]},{"id":"project_3","name":"Offline Maps","createdAt":"2022-07-20T00:00:00Z","url":"#","description":"Offline map navigation app built with Mapbox SDK. Supports offline caching and location tracking without internet.","isFork":false,"languages":[{"name":"Java","iconifyClass":"logos:java"},{"name":"Mapbox","iconifyClass":"simple-icons:mapbox"}]},{"id":"project_4","name":"JS Bank","createdAt":"2023-02-01T00:00:00Z","url":"#","description":"Digital banking app offering full-stack wallet features including bill payments, QR payments, biometric verification (BVS SDK), and clean architecture with Jetpack Compose.","isFork":false,"languages":[{"name":"Kotlin","iconifyClass":"logos:kotlin"},{"name":"XML","iconifyClass":"vscode-icons:file-type-xml"}]},{"id":"project_5","name":"Zindigi","createdAt":"2023-02-01T00:00:00Z","url":"#","description":"Digital banking app offering full-stack wallet features including bill payments, QR payments, biometric verification (BVS SDK), and clean architecture with Jetpack Compose.","isFork":false,"languages":[{"name":"Kotlin","iconifyClass":"logos:kotlin"},{"name":"XML","iconifyClass":"vscode-icons:file-type-xml"}]},{"id":"project_6","name":"Bank Islami App","createdAt":"2023-04-15T00:00:00Z","url":"#","description":"Contributed to core modules of Bank Islami\u2019s mobile banking app, including secure login, payment flows, and API layer refactoring using MVVM and Jetpack components.","isFork":false,"languages":[{"name":"Kotlin","iconifyClass":"logos:kotlin"},{"name":"XML","iconifyClass":"vscode-icons:file-type-xml"}]},{"id":"project_7","name":"Aik Digital Wallet","createdAt":"2023-05-20T00:00:00Z","url":"#","description":"Worked on wallet onboarding, user KYC, and secure transaction flows. Integrated Firebase, biometric login, and in-app notifications.","isFork":false,"languages":[{"name":"Kotlin","iconifyClass":"logos:kotlin"},{"name":"Jetpack Compose","iconifyClass":"simple-icons:jetpackcompose"}]},{"id":"project_8","name":"WebRTC Audio/Video Call App","createdAt":"2023-08-05T00:00:00Z","url":"#","description":"A personal learning project using WebRTC to implement peer-to-peer audio and video calling. Developed a custom signaling server using WebSockets and implemented media stream handling in Android using Kotlin.","isFork":false,"languages":[{"name":"Kotlin","iconifyClass":"logos:kotlin"},{"name":"WebRTC","iconifyClass":"simple-icons:webrtc"},{"name":"WebSocket","iconifyClass":"simple-icons:websocket"}]},{"id":"project_9","name":"DevOps CI/CD Pipeline for Android","createdAt":"2023-09-10T00:00:00Z","url":"#","description":"Implemented a Jenkins-based CI/CD pipeline that automatically builds Android APKs and pushes code to the repository. Included steps for unit testing, code quality checks, versioning, and secure deployment to internal Play Store tracks.","isFork":false,"languages":[{"name":"Groovy","iconifyClass":"simple-icons:groovy"},{"name":"Jenkins","iconifyClass":"simple-icons:jenkins"},{"name":"Gradle","iconifyClass":"logos:gradle"}]}]}'
      );
    },
    ,
    function (t, e, a) {
    ...
    function (t, e) {
      t.exports =
        "data:image/png;base64,";
    },
    function (t, e, a) {
      t.exports = a.p + "static/media/arid_logo.4aec41af.png";
    },
    function (t, e, a) {
    ...
    function (t, e) {
      t.exports =
        "data:image/png;base64,";
    },
    function (t, e, a) {
    ...
    function (t, e, a) {
      ...
      const p = !0,
        ...
        A = {
          ...
          portfolio_repository:
            "https://github.com/UbaidUrRehman583/My-Portfolio.git",
          ...
          data: [
            {
              ...
              softwareSkills: [
                ...
                },
                {
                  ...
                  style: { backgroundColor: "white", color: "#A41E11" },
                },
                {
                  skillName: "Android",
        ...
        x = {
          ...
          subtitle:
            "Street 0, Model Colony, Rawalpindi, Punjab 44000, Pakistan",
          locality: "Rawalpindi",
          country: "Pakistan",
          region: "Punjab",
          postalCode: "44000",
        ...
        Z = { title: "Phone Number", subtitle: "+92 314 5837626" };
      var k = a(81);
      var N = function () {
        ...
        const v = {
          ...
          url:
            null === g || void 0 === g || null === (r = g.og) || void 0 === r
              ...
              : r.url,
          email: b,
          telephone: null === (o = Z) || void 0 === o ? void 0 : o.subtitle,
          sameAs: p,
          jobTitle: C.title,
          ...
          address: {
            "@type": "PostalAddress",
            addressLocality:
              null === (l = x) || void 0 === l ? void 0 : l.locality,
            addressRegion: null === (n = x) || void 0 === n ? void 0 : n.region,
            addressCountry:
              null === (i = x) || void 0 === i ? void 0 : i.country,
            postalCode:
              null === (c = x) || void 0 === c ? void 0 : c.postalCode,
            streetAddress:
              null === (h = x) || void 0 === h ? void 0 : h.streetAddress,
          },
          hasCredential: w,
        };
      ...
      function W(t) {
        return "DataScienceImg" === t.fileName
          ? s.a.createElement(V, { theme: t.theme })
          : "FullStackImg" === t.fileName
          ? s.a.createElement(q, { theme: t.theme })
              ...
              s.a.createElement(
                ...
                s.a.createElement(
                  ...
                  s.a.createElement(
                    ...
                    s.a.createElement(W, { fileName: e.fileName, theme: t })
                  )
                ),
                s.a.createElement(
                  "div",
      ...
      class at extends r.Component {
        render() {
          return s.a.createElement(
            "div",
            null,
            s.a.createElement(S, { theme: this.props.theme }),
            s.a.createElement(X, { theme: this.props.theme }),
            s.a.createElement($, { theme: this.props.theme }),
      ...
      function lt(t) {
        return s.a.createElement(
          ...
          s.a.createElement(
            ...
            s.a.createElement(ot, { id: "logo", theme: t.theme })
          )
        );
      }
        ...
        render() {
          ...
          return s.a.createElement(
            ...
            s.a.createElement(
              ...
              C.degrees.map((e) =>
                s.a.createElement(ht, { degree: e, theme: t })
              )
            )
          );
        }
      ...
      class vt extends r.Component {
        render() {
          ...
          return s.a.createElement(
            ...
            s.a.createElement(yt, { sections: y.sections, theme: t }),
      ...
      class Ot extends r.Component {
        render() {
          ...
          return s.a.createElement(
            ...
            s.a.createElement(Tt, { logos: It.data })
          );
        }
      }
      var zt = Ot;
        ...
        render() {
          ...
          return s.a.createElement(
            ...
            s.a.createElement(
              ...
              Zt.data.map((t) => s.a.createElement(Qt, { pullRequest: t }))
            )
          );
        }
      }
        ...
        render() {
          ...
          return s.a.createElement(
            ...
            s.a.createElement(
              ...
              Bt.data.map((t) => s.a.createElement(Lt, { issue: t }))
            )
          );
        }
      }
      ...
      class qt extends r.Component {
        render() {
          return s.a.createElement(
            ...
            s.a.createElement(S, { theme: this.props.theme }),
            s.a.createElement(zt, { theme: this.props.theme }),
              ...
              s.a.createElement(
                ...
                s.a.createElement(
                  ...
                  s.a.createElement(
                    ...
                    s.a.createElement("img", {
                      src: a(32)("./".concat(Wt.profile_image_path)),
                      alt: "",
                    })
                  ),
                  s.a.createElement(
        ...
        render() {
          ...
          return s.a.createElement(
            ...
            s.a.createElement(
              ...
              se.data.map((e) => s.a.createElement(re, { repo: e, theme: t }))
            ),
            s.a.createElement(z, {
              text: "More Projects",
              className: "project-button",
              href: A.githubProfile,
              newTab: !0,
              theme: t,
            }),
            s.a.createElement(tt, {
...
//# sourceMappingURL=main.45f6c6a3.chunk.js.map
